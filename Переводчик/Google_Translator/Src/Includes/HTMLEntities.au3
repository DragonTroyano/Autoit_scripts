...
; Author( .......: Raik, Mod. by G.Sandler (MrCreatoR)
; ===============================================================================================================================
; #CONSTANTS# ===================================================================================================================
...
;                  $iMode [Optional] - If this parameter <> 0, string encoded to textual entities, otherwise to numeric.
...
; Example .......; Yes
; ===============================================================================================================================
Func _HTMLEntities_Encode($sTxt, $iMode = 0)
	Local $aTxt, $sChr
	
	If $iMode = 0 Then
		$aTxt = StringToASCIIArray($sTxt)
		$sTxt = ''
